...
const CustomerHeader = () => {
  return (
    <header className="w-full gap-6 flex flex-col justify-center items-center">
      <div className="bg-primary-70 w-full py-6 px-4 mt-16 md:mt-0 md:p-16 flex flex-col items-center justify-center">
        ...
        <div className="relative mt-6 w-full max-w-[343px] md:max-w-[813px]">
          <input
            ...
            className="placeholder:text-label-assistive border border-primary-20 bg-white rounded-[6px] py-2 px-3 pr-6  w-full focus:outline-none"
          />
